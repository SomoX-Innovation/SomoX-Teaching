...
const OrganizationTasks = () => {
  ...
  return (
    <div className="organization-tasks-container">
      <div className="organization-tasks-card">
        {error && (
        ...
        {/* Header */}
        <div className="organization-tasks-header">
          <div className="header-content">
            <div className="header-icon-wrapper">
              <FaTasks className="header-icon" />
            </div>
            <div>
              <h1 className="organization-tasks-title">Tasks Management</h1>
              <p className="organization-tasks-subtitle">Manage all tasks and assignments</p>
            </div>
          </div>
