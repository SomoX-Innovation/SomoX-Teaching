...
import './OrganizationBlog.css';

const OrganizationBlog = () => {
  ...
  return (
    <div className="organization-blog-container">
      <div className="organization-blog-card">
        {error && (
        ...
        {/* Header */}
        <div className="organization-blog-header">
          <div className="header-content">
            <div className="header-icon-wrapper">
              <FaBook className="header-icon" />
            </div>
            <div>
              <h1 className="organization-blog-title">Blog Management</h1>
              <p className="organization-blog-subtitle">Manage all blog posts and articles</p>
            </div>
          </div>
...
export default OrganizationBlog;
