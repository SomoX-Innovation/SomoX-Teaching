...
const TeacherBlog = () => {
  ...
  return (
    <div className="teacher-blog-container">
      <div className="teacher-blog-card">
        {error && (
        ...
        {/* Header */}
        <div className="teacher-blog-header">
          <div className="header-content">
            <div className="header-icon-wrapper">
              <FaBook className="header-icon" />
            </div>
            <div>
              <h1 className="teacher-blog-title">Blog Management</h1>
              <p className="teacher-blog-subtitle">Manage all blog posts and articles</p>
            </div>
          </div>
